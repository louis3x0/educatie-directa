...
class Controller
{
    ...
    // user
    public function user($viewName, $data = [])
    {
        $viewFile = "../app/views/user/" . $viewName . ".php";
    ...
    public function component($viewName, $data = [])
    {
        $viewFile = "../app/views/components/" . $viewName . ".php";
